...
export default function About() {
    ...
    return (
        <section className="bg-[#f3eee8] px-6 xl:px-10 2xl:px-12  py-20 xl:py-24 2xl:py-28 w-full  min-h-screen relative z-10">
            <div className="w-full flex flex-col gap-120 xl:gap-140 relative top-0 left-0">

                {/* Text block — top right aligned (offset left via padding) */}
                <div className="xl:max-w-[77.5%] xl:pl-[38%] ">
                    <p
            ...
            <div className="w-full h-full absolute top-100 xl:top-150 left-0 px-6 xl:px-10">
                ...
                <div className="relative w-full flex justify-center top-100 xl:-top-14 xl:right-32 ">

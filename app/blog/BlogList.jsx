        ...
        <div ref={containerRef} className="w-full lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl mx-auto  pt-32">
            <div className="w-full flex flex-col lg:flex-row justify-center items-start gap-8 ">
                ...
                <div ref={headingRef} className="hidden lg:block w-full lg:w-[35%] flex-shrink-0 px-5 md:px-10 lg:px-0">
                    <h2 className=" font-opensans font-light tracking-tight [transform:scaleY(0.75)] text-[36px] md:text-[38px] xl:text-[48px] 2xl:text-[66px] 2xl:leading-18  pt-10 text-black ">
                        Stories worth your time
                    </h2>
                </div>
                <div className="lg:hidden w-full lg:w-[35%] flex-shrink-0 px-5 md:px-10 lg:px-0">
                    <h2 className=" font-opensans font-light tracking-tight [transform:scaleY(0.75)] text-[36px] md:text-[38px] xl:text-[48px] 2xl:text-[66px] 2xl:leading-18 relative top-10  text-black ">
                        Stories worth your time
                    </h2>
                </div>
